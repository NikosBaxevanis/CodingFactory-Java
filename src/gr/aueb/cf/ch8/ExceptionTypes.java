...
public class ExceptionTypes {
     ...
     * it has to be explicitly to be thrown in method signature cc "import java.io.IOException"
     * Or has to be to caught {catch}
     ...
     * If there is a client / user then we dont propagate the exception.
     * @return
     */
    ...
    public static char readAgainOneChar(char ch) throws IOException , IllegalArgumentException {
        ...
        /*
         * or catch (IOException | IllegalArgumentException) {
         * e.printStackTrace();
         * System.err.println(e.getMessage());
         * throw e;
         */
